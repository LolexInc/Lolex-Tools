print ("This script is copyrighted by Jensen Taylor 2014 - 2016(C). JT Tools script version 5.8.0 Beta")
...
if modewanted == 11:
 foldername =input("Please input the name of the folder that you wish to create.")
