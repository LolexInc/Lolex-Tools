...
def correctpath(path):
    #### DO NOT PASS ANYTHING LESS THAN TWO CHARACTERS UNLESS IT'S ./ OR / OR SOMETHING SIMILAR
    slash = "\\"
    class zz:
        p = path
    zz.p = zz.p.replace(slash[0], "/")
    if (zz.p[0] == "." and zz.p[1] == "/") or (zz.p[0] == "/" and uos.useros == "Windows"):
        if zz.p[0] == "/":
            zz.p = "." + zz.p
        zz.p = zz.p[2:]
        tlen = 2
        ### CHECK MIDLEN NOT DEFINED
        zz.p = correctpath(os.getcwd()) + zz.p
    if zz.p[len(zz.p) - 1] != "/":
    ...
    while True:
        ...
        if expl.file == "///?":
            ...
            if allowexit == 1:
                ...
                time.sleep(5)
        elif expl.file != "///s" and expl.file != "///o" and expl.file != ".." and expl.file != "./" and expl.file != "///":
            o = False
            found = 0
            arraypos = 0
            possibles = []
...
>>>>>>> b74bd090fccf29dcc5c6d22be47c5dfd2813c31e
